package io.michaeljgkopp.github.stocktradingclient;

import io.michaeljgkopp.github.stocktradingclient.service.StockClientService;
...
public class StockTradingClientApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    System.out.println(
        "Grpc client response : " + stockClientService.getStockPrice("GOOGL"));  // AAPL
  }
}
